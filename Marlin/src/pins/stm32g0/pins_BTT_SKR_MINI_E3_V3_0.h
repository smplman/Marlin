...
#define EXP1_03_PIN                         PD6
  ...
  #define BTN_ENC                           PB5
    ...
    //#error "CAUTION! BTT_MINI_12864_V1 requires wiring modifications. See 'pins_BTT_SKR_MINI_E3_common.h' for details. Comment out this line to continue."
    ...
    #define BTN_ENC                         EXP1_09_PIN //EXP1_9
    #define BTN_EN1                         PA9
    #define BTN_EN2                         PA10

    #define DOGLCD_CS                       EXP1_03_PIN //EXP1_3
    ...
    #define LCD_CONTRAST_MIN                200
      ...
      #undef NEOPIXEL_PIN
    #endif
    #define NEOPIXEL_PIN                    PB5 //PA8

  #else
    #error "Only CR10_STOCKDISPLAY, ZONESTAR_LCD, ENDER2_STOCKDISPLAY, MKS_MINI_12864, BTT_MINI_12864_V1, and TFTGLCD_PANEL_(SPI|I2C) are currently supported on the BIGTREE_SKR_MINI_E3."
  #endif
