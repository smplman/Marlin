...
#define CUSTOM_MACHINE_NAME "gMax 1.5XT"
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1100, 1100, 100, 1200 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 33, -4, -2.3 }
...
#define HOMING_FEEDRATE_MM_M { (75*60), (75*60), (11*60) }
